...
- Name: landing.spec.ts >> Landing Page — CRO & Conversion >> hero heading and subheading visible
- Location: e2e/landing.spec.ts:8:7
...
Locator: getByText(/Dijital Resepsiyonist/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/Dijital Resepsiyonist/i)
