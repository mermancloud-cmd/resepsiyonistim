    ...
    <div className="flex min-h-screen flex-col">
      ...
      <header className="flex items-center justify-between px-6 py-4 max-w-6xl mx-auto w-full">
        <div className="flex items-center gap-2">
          <div className="size-8 rounded-lg bg-gradient-to-br from-amber-600 to-amber-700 flex items-center justify-center text-white font-bold text-sm">R</div>
      ...
      <section className="flex-1 flex flex-col items-center justify-center px-6 py-16 text-center">
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <p className="text-lg text-muted-foreground max-w-xl mx-auto">
            ...
            Misafirlerinizle insan gibi konuşur, anında yanıtlar, rezervasyonları otomatik alır.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-emerald-600 text-white px-7 py-3.5 rounded-xl font-bold shadow-lg hover:bg-emerald-700 hover:shadow-xl transition-all text-sm ring-2 ring-emerald-400/50 animate-pulse-ring"
            >
          ...
          <p className="text-xs text-muted-foreground/70">
            Nasıl konuştuğunu görmek için WhatsApp'ı aç. Test işletmemiz <strong>Merman</strong> seni bekliyor.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 py-16 border-t border-border">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-2xl font-bold">Dijital Resepsiyonistin Ne Yapabilir?</h2>
            <p className="text-muted-foreground mt-2">7/24 çalışır, insan gibi konuşur, sen uyurken bile yanıtlar</p>
          </div>
...
const features = [
  { icon: "💬", title: "7/24 WhatsApp İletişim", desc: "Misafirleriniz WhatsApp'tan yazar, resepsiyonistiniz anında insan gibi yanıtlar." },
